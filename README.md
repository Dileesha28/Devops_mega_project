...
![Pipeline Overview](./src/archi123.png)
...
1. **Clone the Repository** (Open Command Prompt & run below):
   ```bash
   git clone https://github.com/Dileesha28/Amazon-Prime-Clone-Deployment-Project.git
   cd DevopsProject2
...
pipeline {
    ...
    stages {
        stage('1. Git Checkout') {
            steps {
                git branch: 'main', url: 'https://github.com/Dileesha28/Amazon-Prime-Clone-Deployment-Project.git'
            }
        }
